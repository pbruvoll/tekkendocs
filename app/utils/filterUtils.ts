...
export const getFilterFromParams = (
  ...
  return {
    ...
    duckableString: getSearchParamBoolean(
      searchParams,
    ...
    interruptibleMin: getSearchParamNumber(
      searchParams,
      filterKey.InterruptibleMin,
    ),
    interruptibleMax: getSearchParamNumber(
      searchParams,
      filterKey.InterruptibleMax,
    ),
    ...
    head: getSearchParamBoolean(searchParams, filterKey.Head),
    shoulder: getSearchParamBoolean(searchParams, filterKey.Shoulder),
    hip: getSearchParamBoolean(searchParams, filterKey.Hip),
    ...
    favorite: getSearchParamBoolean(searchParams, filterKey.Favorite),
  };
};
