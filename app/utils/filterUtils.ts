...
export const getFilterFromParams = (
  ...
  return {
    ...
    startupFrameMin: getSearchParamNumber(searchParams, filterKey.StartupFrameMin),
    startupFrameMax: getSearchParamNumber(searchParams, filterKey.StartupFrameMax),
